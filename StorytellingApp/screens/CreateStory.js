...
import {View,Text,StyleSheet,SafeAreaView,Platform,StatusBar,Image,ScrollView,TextInput,Dimensions} from "react-native";
            ...
            <ScrollView>
              ...
              <View style={{ height: RFValue(this.state.dropdownHeight) }}>
                <DropDownPicker
                  ...
                  labelStyle={
                    this.state.light_theme?styles.dropdownLableLight:styles.dropdownLable
                  }
                  arrowStyle={
                    this.state.light_theme?styles.dropdownLableLight:styles.dropdownLable
                  }
